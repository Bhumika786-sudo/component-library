...
const StyledText = styled.p<TextProps>`
  background-color: ${(props: TextProps) => props.disabled ? '#f0f0f0' : props.backgroundColor || 'transparent'};
  color: ${(props: TextProps) => props.disabled ? '#999999' : props.textColor || '#000000'};
